...
public class EmailNotification implements Serializable {
    ...
    public static EmailNotification forNewOrderRegistration(OrderSendEmailDto order) {
        String subject = "Pedido enviado!";
        String body = String.format(
                "Hola %s,\n\nSu pedido se ha enviado a su dirección: %s",
                order.getName(), order.getAddress() // Pasa los valores aquí
        );


        return new EmailNotification(order.getEmail(), subject, body);
    }
